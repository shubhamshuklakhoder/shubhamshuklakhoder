  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-[400px] shadow-sm" data-testid="login-card">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-semibold" data-testid="login-title">Welcome back</CardTitle>
            <CardDescription data-testid="login-desc">Enter your credentials to continue</CardDescription>
          </CardHeader>
          <CardContent>
